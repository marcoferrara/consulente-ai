...
- [index.html](file:///Users/marco/Claude%20Code/Consulente%20AI/demo/studio_associato/index.html): L'interfaccia utente (HTML5/CSS3/Vanilla JS) scura con finiture dorate e glassmorphism.
- [app.py](file:///Users/marco/Claude%20Code/Consulente%20AI/demo/studio_associato/app.py): Server API FastAPI che implementa le rotte `/api/match`, `/api/search` e `/api/send_alert`.
- [config.py](file:///Users/marco/Claude%20Code/Consulente%20AI/demo/studio_associato/config.py): Database simulato contenente 4 bandi reali sardi e 7 aziende clienti (es. *Cantine Sa Corona, Agriturismo Antiga Luna S.r.l., Pastificio Antiga Armonia*).
- [requirements.txt](file:///Users/marco/Claude%20Code/Consulente%20AI/demo/studio_associato/requirements.txt): File dei requisiti Python.
