...
1. Assicurati di trovarti nella cartella `demo/laboratorio_artistico/`:
   ```bash
   cd demo/laboratorio_artistico
   ```
...
*   **Direttamente:** Apri il file `demo/laboratorio_artistico/index.html` nel browser.
